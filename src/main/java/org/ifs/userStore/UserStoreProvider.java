...
@JBossLog
public class UserStoreProvider implements UserStorageProvider, UserLookupProvider,UserQueryProvider, CredentialInputValidator, CredentialInputUpdater {
    ...
    public UserStoreProvider(KeycloakSession session, ComponentModel model, UserRepository repository){
